        ...
        <>
            <nav className='flex w-full h-20 flex-col justify-center items-center flex-wrap border-b border-gray-700'>
                <div className='flex w-full flex-row justify-between flex-wrap items-center'>
                    <div className='flex w-3/6 justify-evenly flex-wrap'>
                        <div className='flex justify-center w-2/7 object-cover'>
                            <img src={LOGO} alt="Company Logo" />
                        </div>
                        <div className='flex justify-around p-2 items-center flex-row w-2/5 mr-5 text-black font-medium'>
